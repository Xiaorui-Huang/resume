...
\personalinfo{%
  % Not all of these are required!
    \printinfo{\faCalendar}{Availability: \hspace{0.5ex} From May 2024}
    \printinfo{\faUser}{Preferred Name: \hspace{0.5ex} Richard}
...
\cvevent{eAI Machine Learning Engineer}{Qualcomm}{May 2023 --- August 2023}{Markham, ON}
\begin{itemize}
...
\begin{itemize}
    ...
    \item  \textbf{CSC413 Deep Learning --- 96\%} Transformers, CNN,
        ...
        strategy as final course project.\ \github{RolandGao/pycls}
    
    % \item  \textbf{CSC258 Computer Organization - 95\%} Implemented and
    % understood core computer component from basic circuits as well as
...
\cvsection{Research}
\cvevent{Linearly Explored Learning Rate Scheduler (LES)}{}{Apr 2022 \github{RolandGao/pycls}}{} 
\begin{itemize}
