...
\begin{paracol}{2}
    ...
    \cvevent{University of Toronto \faUniversity}{Candidate for HBSc.\ in Computer Science}{2019 --- Expected June 2024}{}
    % \vspace{-5pt}
    \begin{itemize}
        ...
        \item CSC413 \textbf{Deep Learning (96\%)} --- Transformers, CNN, RNN, GAN, VAE, GNN, RL, Model Tuning techniques
    ...
    \begin{itemize}
        \item Research on \textbf{3D Gaussian Splatting} \& \textbf{NeRF} with real-time SLAM systems on data captured on embedde devices.
