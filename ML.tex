...
\begin{paracol}{2}
    ...
    \personalinfo{%
        ...
        \printinfo{\faUser}{Preferred Name: \hspace{0.5ex} \textbf{Richard}}
    ...
    \cvevent{University of Toronto \faUniversity}{Candidate for B.Sc.\ in Computer Science}{2019 --- Now (Exp 2024) }{Toronto, ON}
    \vspace{-5pt}
    ...
    \cvsection{Research}
    \cvevent{ML Reseach Intern}{embARC Research Group}{Jan 2024 - Now}{University of Toronto}
    \begin{itemize}
    ...
    \cvtag{3D Gaussian Splatting} \cvtag{SLAM} \cvtag{Pytorch} \cvtag{C/C++} \cvtag{CUDA}
    ...
    {November 2023 \github{Xiaorui-Huang/cuda-ray-tracing}
    }{}
    \begin{itemize}
        \item Implemented a \textbf{CUDA} ray tracer with \textbf{BVH} acceleration structure, with \textbf{Blinn-Phong} shading.
        \item Achieved \textbf{real-time} ray-tracing of \textbf{1000+} triangles with \textbf{30} FPS.
