...
\begin{paracol}{2}
    ...
    \cvsection{Research}
    \cvevent{Machine Learning Reseacher}{embARC Research Group}{Jan 2024 - Now \github{Xiaorui-Huang/DISORF}}{}
    \begin{itemize}
    ...
    \vspace{-5pt}
    \divider{}
    \cvevent{Doodle Jumps}{Pure Assembly Game Dev}
    {Dev 2021 \github{Xiaorui-Huang/doodle-jump}}{}
    \begin{itemize}
