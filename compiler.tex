...
\begin{paracol}{2}
    ...
    \cvsection{Research}
    \cvevent{Distributed Online 3D Reconstruction}{embARC Research Group}{Jan 2024 --- July 2024}{University of Toronto}
    \begin{itemize}
        ...
        \item Paper is accepted for publication in \textbf{IEEE RA-L} and transferred to \textbf{ICRA 2025}, availble on \github{Xiaorui-Huang/DISORF}
    \end{itemize}
