...
\begin{paracol}{2}
    ...
    \personalinfo{%
        ...
        \printinfo{\faUser}{Preferred Name: Richard}
    ...
    \cvevent{Low Power AI Machine Learning Engineer}{Qualcomm}{May 2023 --- Aug 2023}{Markham, Canada}
    \begin{itemize}
        \item Led efforts on \textbf{Neural Architecture Search (NAS)} and model compression within the Edge AI R\&D team.
        ...
        \item Developed a NAS framework, leveraging Qualcomm's patented NAS
              techniques, optimizes a given models on a pre-profiled hardware,
              built with Pytorch's \textbf{torch.fx}

              % \item Streamlined the NAS workflow for incoming client models, slashing
              %       \textbf{engineering time} by \textbf{80\%}.

        \item Achieved  \textbf{50\% reduction} in \textbf{model size} and
              \textbf{60\% drop in inference latency} without compromising accuracy across benchmark models, while reducing engineering time compared to manually applied NAS.
              ...
              % \item Participated in team-wide discussions on \textbf{ML graph
              %     optimization} for the next-generation \textbf{eNPU}, with a focus on
              %     quantization and attention mechanisms.
        \item Engaged in team-wide discussions on next-generation \textbf{eNPU Compiler Stack}, focusing on \textbf{quantization} and \textbf{attention mechanisms}.
    ...
    \cvevent{RPA Backend Developer}{IBM}{May 2022 --- Apr 2023}{Markham, Canada}

    \begin{itemize}

        \item Worked on backend development for IBM's Robotics Process Automation (RPA) platform, written in C\# \textbf{OOP}.

        \item Augmented IBM RPA's \textit{WAL} programming language with new features inspired by Java and C\#.

        \item Collaborated with cross-functional teams, achieving a \textbf{15\%} reduction in customer issues and defects per release.

        \item Employed \textbf{agile methodologies} on large mono-repo, showed both independent and
              collaborative competencies in a hybrid work environment.

        \item Presented novel solution to RPA's senior architects and product teams.

    \end{itemize}
    \cvtag{C\#}
    \cvtag{OOP}
    \cvtag{Large Monorepo}
    ...
    % \cvevent{University of Toronto \faUniversity}{Honors BSc.\ in Computer Science}{Sep 2019 --- Jun 2024 }% \textit{(includes one year fulltime co-op)}}{}
    \cvevent{University of Toronto \faUniversity}{Honors BSc.\ in Computer Science}{Sep 2019 --- Jun 2024}{}
    % \vspace{-5pt}
    \begin{itemize}
        \item CSC401 \textbf{Natural Language Processing} (84\%) --- N-gram models, neural machine translation, \textbf{transformers}, speech recognition \& advanced in \textbf{LLMs}
        \item CSC413 \textbf{Deep Learning} (96\%) --- \textbf{Transformers}, CNN, RNN, GAN, VAE, RL, GNN, Model Tuning techniques
        ...
        % \item ECE568 \textbf{Computer Security} (83\%) --- Buffer Overflow \& Control Hijacking, \textbf{Cache Side-Channel Attacks}, Network Security, Cryptography, Web Security \cvtag{C}\cvtag{x86}
    ...
    % \cvtag{ECE568 Computer Security}
    % \cvtag{C++}
    % \cvtag{Pytorch}
    ...
    \cvsection{Research}
    \cvevent{Distributed Online 3D Reconstruction}{embARC Research Group, University of Toronto}{Jan 2024 --- July 2024}{\github{Xiaorui-Huang/DISORF}}
    \begin{itemize}
        ...
        \item Modified \textbf{CUDA} kernel and integrates novel techniques such as adaptive initalization resolving real-time incremental learning issue.
        \item Paper is accepted for publication in \textbf{IEEE RA-L} (\href{https://ieeexplore.ieee.org/document/10803046}{link}) and to be presented at \textbf{ICRA 2025}
    \end{itemize}
    ...
    \vspace{-5pt}
    \divider{}
    \cvevent{Woodoku Learn}{}{Jul 2022
    ...
    \vspace{-5pt}
    \divider{}
    \cvevent{Doodle Jumps in MIPS Assembly}{}
    {Dec 2021 \github{Xiaorui-Huang/doodle-jump}}{}
    \begin{itemize}
